...
class Drass7Mehwer2 extends StatefulWidget {
  static const routName = '/Drass7Mehwer2';
  const Drass7Mehwer2({super.key});

  @override
  State<Drass7Mehwer2> createState() => _Drass7Mehwer2State();
}

class _Drass7Mehwer2State extends State<Drass7Mehwer2> {
 late VideoPlayerController AssetController;
  ...
  void initState() {
    ...
    //   });});
    AssetController = VideoPlayerController.asset("assets/vedio/akhtar.mp4")
      ..initialize().then((_) {
        ...
        child: ListView(
            ...
            Container(
             ...
             // margin: EdgeInsets.only(left: 250),
              ...
              height: 60,
              child: Text(
                'كن حريصا عند استخدام شبكة الانترنت',
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 25,
